...
public class Armor
{
    ...
    @OneToOne(mappedBy = "armor",cascade = {CascadeType.MERGE})
    CharacterEquipment characterEquipment;

    public Armor() {
    }

    public Armor(String name, int defense, int bonus_str, int bonus_dex, int bonus_int, int bonus_con, CharacterEquipment characterEquipment) {
        this.name = name;
